    ...
    return (
      <StudentShell>
        <div className="py-6 text-center">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Your follow-up has been recorded.</p>
        </div>
      </StudentShell>
    );
  }
  ...
  return (
    <StudentShell>
      ...
      >
        ...
        <Button type="submit" className="w-full" disabled={!allAnswered || submitting}>{submitting ? "Submitting…" : "Submit"}</Button>
      </form>
    </StudentShell>
  );
}
